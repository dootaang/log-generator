...
class ModernLogGenerator(QMainWindow):
    ...
    def create_tag_settings(self):
        ...
        # 기본 태그 3개 추가 - 기본 색상 직접 지정
        default_tags = ["모델", "프롬프트", "번역"]
        default_colors = ["#E3E3E8", "#E3E3E8", "#E3E3E8"]  # 기본 색상 값을 직접 지정
        
        for i, (default_tag, default_color) in enumerate(zip(default_tags, default_colors)):
            ...
            # 태그 색상
            color_btn = ModernColorButton(default_color)  # STYLES 대신 default_color 사용
    ...
    def add_new_tag(self):
        ...
        # 태그 색상 - 기본값 직접 지정
        color_btn = ModernColorButton("#E3E3E8")  # 기본 색상 직접 지정
