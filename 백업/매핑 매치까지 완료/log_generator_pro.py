...
class ModernLogGenerator(QMainWindow):
    ...
    def create_asset_settings(self):
        ...
        group.addWidget(bulk_input_btn)
    ...
    def create_bulk_url_input_dialog(self):
        ...
        # 미리보기 버튼
        preview_btn = ModernButton("매핑 미리보기")
        preview_btn.clicked.connect(lambda: self.show_mapping_preview(
            url_input.toPlainText(),
            list(self.card_handler.image_uri_map.keys())
        ))
